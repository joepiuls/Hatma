...
const AddPortfolioForm = ({ onCancel }) => {
  const [currentStep, setCurrentStep] = useState(1);
  const [images, setImages] = useState([]);
  const [dragActive, setDragActive] = useState(false);
  const [results, setResults] = useState([
    { metric: '', value: '', icon: 'Award' }
  ]);
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Create a new portfolio project to showcase your work</p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              ...
              <button
                ...
                className="flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-xl font-medium shadow-lg hover:shadow-xl transition-all duration-300"
              >
          ...
          <form className="p-8 space-y-8">
            ...
            {currentStep === 1 && (
              <FormSection 
                ...
                description="Enter the essential details about your portfolio project"
            ...
            {currentStep === 2 && (
              <FormSection 
                ...
                description="Provide detailed information about the project"
            ...
            {currentStep === 3 && (
              <FormSection 
                title="Media & Results" 
                description="Upload project images and add performance metrics"
            ...
            {currentStep === 4 && (
              <FormSection 
                ...
                description="Add a testimonial from your client"
